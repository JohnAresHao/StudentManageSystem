    ...
    <el-container>
      <el-main>
        ...
        <el-card style="margin-top: 10px">
          <course-teacher-list :ruleForm="ruleForm"></course-teacher-list>
        </el-card>
      </el-main>
    </el-container>
  </div>
...
<script>
import CourseTeacherList from '@/views/admin/selectCourseManage/CourseTeacherList.vue'
export default {
  components: { CourseTeacherList }, // for test???
  data() {
    return {
      ruleForm: {
        tid: null,
